...
import { Card, Button, BackgroundPatterns } from '@/components/ui';
...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen p-6 bg-food-bg flex flex-col relative overflow-hidden">
      ...
      <header className="flex justify-between items-center mb-12 z-10 bg-white/40 p-4 rounded-3xl food-border backdrop-blur-sm">
        ...
        <Button variant="secondary" className="p-3 bg-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center gap-12">
        ...
        <div className="grid grid-cols-2 gap-6 w-full max-w-md z-10">
          ...
          >
            ...
            <span className="font-black text-xl">待食餐厅</span>
          </Card>
          ...
          >
            ...
            <span className="font-black text-xl">已食餐厅</span>
          </Card>
          ...
          >
            ...
            <span className="font-black text-2xl">餐厅上报</span>
          </Card>
        </div>
      </main>
